...
public class RechargeCommisionModel {
    private String strOperator, strcode, strType, strcommision,strflat,strsurcharge;

    public RechargeCommisionModel(String strOperator, String strcode, String strType, String strcommision, String strflat, String strsurcharge) {
