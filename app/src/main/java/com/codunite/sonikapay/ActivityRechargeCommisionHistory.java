...
import com.codunite.adapter.CommisionHistoryAdapter;
...
public class ActivityRechargeCommisionHistory extends AppCompatActivity implements View.OnClickListener, WebServiceListener {
        ...
        imgSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if ((txtFrom.getText().toString().trim()).equalsIgnoreCase("Select from date")){
                    ...
                    LoadRechargeCommisionHistory(txtFrom.getText().toString().trim(), txtTo.getText().toString().trim());
                }
            }
        });
    ...
    private void LoadRechargeCommisionHistory(String fromDate, String toDate){
