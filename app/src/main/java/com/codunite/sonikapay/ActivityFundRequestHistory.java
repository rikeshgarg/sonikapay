...
import com.codunite.adapter.FundRequestHistoryAdapter;
...
public class ActivityFundRequestHistory extends AppCompatActivity implements View.OnClickListener, WebServiceListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_fund_request_history);
        StartApp();
...
//        txtTo.setText(GetFormattedDateTime.getcurrentcalDate());
    ...
    private void LoadRechargeHistory(String fromDate, String toDate) {
        ...
        callWebService(ApiInterface.GETFUNDREQUESTLIST, lstUploadData);
    }
    ...
    private void StartApp() {
        ...
        errrorScreen = new NoInternetScreen(svContext, root, ActivityFundRequestHistory.this);
...
//        }
    ...
    private void loadToolBar() {
        ...
        txtHeading.setText("Fund Request History");
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_addwallet:
                Intent svIntent = new Intent(svContext, ActivityFundRequestHistory.class);
    ...
    private List<FundRequestHistoryModel> lstItems = new ArrayList<>();
    ...
    public void onWebServiceActionComplete(String result, String url) {
        if (url.contains(ApiInterface.GETFUNDREQUESTLIST)) {
            int strPageCount = 0;
            try {
                ...
                if (str_json_status.equalsIgnoreCase("0")) {
                    ...
                    for (int data_i = 0; data_i < (data).length(); data_i++) {
                        ...
                        String str_request_id = data_obj.getString("request_id");
                        String str_txnid = data_obj.getString("txnid");
                        String str_request_amount = data_obj.getString("request_amount");
                        String payment_screenshot = data_obj.getString("payment_screenshot");
                        String datetime = data_obj.getString("date");
                        String str_mStatus = data_obj.getString("status");
                        ...
                        lstItems.add(new FundRequestHistoryModel(member_name, str_request_id, str_txnid, str_mStatus,
                                str_request_amount, payment_screenshot, datetime, bank_name));
                    }
                }
            } catch (JSONException e) {
            ...
            FundRequestHistoryAdapter mAdapter = new FundRequestHistoryAdapter(this, lstItems, animation_type);
            wallethistoryrv.setAdapter(mAdapter);
            mAdapter.setOnItemClickListener(new FundRequestHistoryAdapter.OnItemClickListener() {
                @Override
                public void onItemClick(View view, FundRequestHistoryModel obj, int position) {
                }

                @Override
                public void onShowScreenshotClick(View view, FundRequestHistoryModel obj, int position) {
                    PreferenceConnector.writeString(svContext, PreferenceConnector.WEBHEADING, "Payment QR");
                    PreferenceConnector.writeString(svContext, PreferenceConnector.WEBURL, obj.getPayment_screen());
