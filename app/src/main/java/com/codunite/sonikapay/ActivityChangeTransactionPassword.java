...
public class ActivityChangeTransactionPassword extends AppCompatActivity implements View.OnClickListener, WebServiceListener, MessageListener {
    private EditText edExistingTranscationPassword, edNewTranscationPassword, edConfirmTranscationPassword;
    private Button btnTPUdapdate;

    private ImageView imgBack;
    private View[] allViewWithClick = {btnTPUdapdate, imgBack};
...
//                break;
    ...
    private void StartApp() {
        ...
        errrorScreen = new NoInternetScreen(svContext, root, ActivityChangeTransactionPassword.this);
