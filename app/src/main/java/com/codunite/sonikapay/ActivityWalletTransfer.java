...
public class ActivityWalletTransfer extends AppCompatActivity implements View.OnClickListener, WebServiceListener, MessageListener {
...
//            lstUploadData.add((listSpinnerCrDr.get(spinnerCrDr.getSelectedItemPosition()).split("#:#")[0]));
    ...
    private void loadToolBar() {
        ...
        txtHeading.setText("Wallet Transfer");
...
//                break;
    ...
    private void StartApp() {
        ...
        errrorScreen = new NoInternetScreen(svContext, root, ActivityWalletTransfer.this);
