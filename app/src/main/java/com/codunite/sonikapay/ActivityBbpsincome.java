...
public class ActivityBbpsincome extends AppCompatActivity implements View.OnClickListener, WebServiceListener {
...
//        cardShowBalance.setVisibility(View.INVISIBLE);
        ...
        callWebService(ApiInterface.GETBBPSINCOME, lstUploadData);
    ...
    private void StartApp() {
        ...
        errrorScreen = new NoInternetScreen(svContext, root, ActivityBbpsincome.this);
...
// FontUtils.setThemeColor(root, svContext, false);
    ...
    private void loadToolBar() {
        ...
        txtHeading.setText("BBPS Income");
    ...
    public void onWebServiceActionComplete(String result, String url) {
        if (url.contains(ApiInterface.GETBBPSINCOME)) {
            try {
