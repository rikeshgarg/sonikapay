...
import com.codunite.adapter.MemberListAdapter;
...
public class ActivityMemberList extends AppCompatActivity implements View.OnClickListener, WebServiceListener {
    ...
    private void StartApp() {
        ...
        errrorScreen = new NoInternetScreen(svContext, root, ActivityMemberList.this);
    ...
    private void loadToolBar() {
        ...
        txtHeading.setText("Member List");
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_addwallet:
                Intent svIntent = new Intent(svContext, ActivityAddMember.class);
