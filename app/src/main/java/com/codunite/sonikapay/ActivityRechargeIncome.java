...
public class ActivityRechargeIncome extends AppCompatActivity implements View.OnClickListener, WebServiceListener {
    ...
    public void resumeApp() {
        ...
        callWebService(ApiInterface.GETRECHARGEINCOME, lstUploadData);
    ...
    private void StartApp() {
        ...
        errrorScreen = new NoInternetScreen(svContext, root, ActivityRechargeIncome.this);
    ...
    private void loadToolBar() {
        ...
        txtHeading.setText("Recharge Income");
    ...
    public void onWebServiceActionComplete(String result, String url) {
        if (url.contains(ApiInterface.GETRECHARGEINCOME)) {
            try {
