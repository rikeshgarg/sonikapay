...
public class ActivityRankList extends AppCompatActivity implements View.OnClickListener, WebServiceListener {
    ...
    public void resumeApp() {
        ...
        callWebService(ApiInterface.GET_RANK_LIST, lstUploadData);
    }
    ...
    private void StartApp() {
        ...
        errrorScreen = new NoInternetScreen(svContext, root, ActivityRankList.this);
    ...
    private List<RankListModel> lstItems = new ArrayList<>();

    @Override
    public void onWebServiceActionComplete(String result, String url) {
        if (url.contains(ApiInterface.GET_RANK_LIST)) {
            try {
                ...
                if (str_status.equalsIgnoreCase("0")) {
                    ...
                    for (int data_i = 0; data_i < ((JSONArray) data).length(); data_i++) {
                        ...
                        String str_rank_id = data_obj.getString("rank_id");
                        String str_title = data_obj.getString("title");
                        String str_total_user = data_obj.getString("total_user");
                        lstItems.add(new RankListModel(str_rank_id, str_title, str_total_user));
                    }
                }
            ...
            RankListAdapter mAdapter = new RankListAdapter(this, lstItems, animation_type);
            ...
            mAdapter.setOnItemClickListener(new RankListAdapter.OnItemClickListener() {
                @Override
                public void onItemClick(View view, RankListModel obj, int position) {
                    Intent intent = new Intent(svContext, ActivityRankAchieverList.class);
                    intent.putExtra("rank_id", obj.getRankId());
    ...
    public class RankListModel {
        ...
        private String title, totalUsers, rankId;

        public RankListModel(String rankId, String title, String totalUsers) {
            this.rankId = rankId;
            this.title = title;
    ...
    public static class RankListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        private List<RankListModel> items;
        ...
        public interface OnItemClickListener {
            void onItemClick(View view, RankListModel obj, int position);
        }
        ...
        public RankListAdapter(Context context, List<RankListModel> items, int animation_type) {
            this.items = items;
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_ranklist, parent, false);
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
            if (holder instanceof OriginalViewHolder) {
                ...
                RankListModel model = items.get(position);
