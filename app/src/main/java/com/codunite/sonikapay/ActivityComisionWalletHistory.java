...
public class ActivityComisionWalletHistory extends AppCompatActivity implements View.OnClickListener, WebServiceListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_commissionwallethistory);
        StartApp();
    ...
    public void resumeApp() {
        ...
        txtWalletbal.setText(PreferenceConnector.readString(svContext, PreferenceConnector.COMMISIONBALANCE, "0"));
...
//        txtTo.setText(GetFormattedDateTime.getcurrentcalDate());
    ...
    private void LoadHistory(String fromDate, String toDate){
        ...
        callWebService(ApiInterface.GETCOMMISIONWALLETHISTORY, lstUploadData);
    }
    ...
    private void StartApp() {
        ...
        errrorScreen = new NoInternetScreen(svContext, root, ActivityComisionWalletHistory.this);
    ...
    private void loadToolBar() {
        ...
        txtHeading.setText("Commission Wallet History");
    ...
    public void onWebServiceActionComplete(String result, String url) {
        if (url.contains(ApiInterface.GETCOMMISIONWALLETHISTORY)) {
            int strPageCount = 0;
            try {
