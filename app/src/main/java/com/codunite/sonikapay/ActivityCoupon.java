...
public class ActivityCoupon extends AppCompatActivity implements View.OnClickListener, WebServiceListener {
    private Button btnSubmit,btncancel;
    private View[] allViewWithClick = {btnSubmit,btncancel};
    private int[] allViewWithClickId = {R.id.btn_submitcontact,R.id.btn_cancel};

    private EditText edLoginId;
    private EditText edCoupon;
    private EditText[] edTexts = {edLoginId,edCoupon};
    private String[] edError = {"Enter PSA Login Id", "Enter Coupon"};
    private int[] editTextsClickId = {R.id.edt_loginid, R.id.edt_couponlist};
    ...
    private void EditTextDeclare(EditText[] editTexts) {
        ...
        edLoginId = (EditText) editTexts[0];
        edCoupon = (EditText) editTexts[1];
    }
                    ...
                    switch (v.getId()) {
                        case R.id.btn_submitcontact:
                            ...
                            if (response == 0) {
                                ...
                                lstUploadData.add(getEditextValue(edLoginId));
                                lstUploadData.add(edCoupon.getText().toString().trim());
                                callWebService(ApiInterface.PURCHASECOUPONAUTH, lstUploadData);
                            }
                            break;
    ...
    private void StartApp() {
        ...
        strfrom_act = getIntent().getStringExtra("from_act");
        ViewGroup root = (ViewGroup) findViewById(R.id.headlayout);
        errrorScreen = new NoInternetScreen(svContext, root, ActivityCoupon.this);
...
//            FontUtils.setThemeColor(root, svContext, false);
    ...
    public void onWebServiceActionComplete(String result, String url) {
        if (url.contains(ApiInterface.PURCHASECOUPONAUTH)) {
            try {
                ...
                if (str_status.equalsIgnoreCase("0")) {
                    ...
                    String edlogin =json.getString("psa_login_id");
                    //edLoginId=json.getString("psa_login_id");
