...
import com.codunite.adapter.LevelIncomeAdapter;
...
public class ActivityLevelincome extends AppCompatActivity implements View.OnClickListener, WebServiceListener {
...
//
        ...
        callWebService(ApiInterface.GETLEVELINCOME, lstUploadData);
    ...
    private void StartApp() {
        ...
        errrorScreen = new NoInternetScreen(svContext, root, ActivityLevelincome.this);
...
// FontUtils.setThemeColor(root, svContext, false);
    ...
    private void loadToolBar() {
        ...
        txtHeading.setText("Level Income");
    ...
    public void onWebServiceActionComplete(String result, String url) {
        if (url.contains(ApiInterface.GETLEVELINCOME)) {
            try {
                ...
                if (str_status.equalsIgnoreCase("0")) {
                    ...
                    for (int data_i = 0; data_i < ((JSONArray) data).length(); data_i++) {
                        ...
                        String str_by_member = data_obj.getString("from_member");
                        String str_level_num = data_obj.getString("level_num");
                        String str_wallet_settle_amount = data_obj.getString("wallet_settle_amount");
                        String str_is_paid = data_obj.getString("is_paid");
...
//            txtWalletbal.setVisibility(View.VISIBLE);
            ...
            LevelIncomeAdapter mAdapter = new LevelIncomeAdapter(this, lstItems, animation_type);
            wallethistoryrv.setNestedScrollingEnabled(false);
            wallethistoryrv.setAdapter(mAdapter);
            mAdapter.setOnItemClickListener(new LevelIncomeAdapter.OnItemClickListener() {
                @Override
