...
public class ActivityDirectIncome extends AppCompatActivity implements View.OnClickListener, WebServiceListener {
    ...
    private void LoadData() {
        ...
        callWebService(ApiInterface.GETDIRECTINCOME, lstUploadData);
    }
    ...
    private void StartApp() {
        ...
        errrorScreen = new NoInternetScreen(svContext, root, ActivityDirectIncome.this);
    ...
    private void loadToolBar() {
        ...
        txtHeading.setText("Direct Income");
