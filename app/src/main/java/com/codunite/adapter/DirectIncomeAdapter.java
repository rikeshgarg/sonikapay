...
public class DirectIncomeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<DirectIncomeModel> items = new ArrayList<>();
    private Context ctx;
    ...
    public DirectIncomeAdapter(Context context, List<DirectIncomeModel> items, int animation_type) {
        this.items = items;
        ctx = context;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_directincome, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof OriginalViewHolder) {
            ...
            view.level.setText(items.get(position).getStr_by_member());
            view.member.setText(items.get(position).getStr_direct_amount());
            view.membership.setText(items.get(position).getStr_is_paid());
            view.email.setText(items.get(position).getStr_date());
            view.mobile.setText(items.get(position).getStr_tds_amount());
