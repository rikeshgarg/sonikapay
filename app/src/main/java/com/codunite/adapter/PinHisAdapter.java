...
public class PinHisAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PinHisAdapter(Context context, List<WalletHistoryModel> items, int animation_type) {
        this.items = items;
        ctx = context;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_pinhis, parent, false);
