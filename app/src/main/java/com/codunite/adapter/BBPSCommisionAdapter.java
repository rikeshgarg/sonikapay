...
public class BBPSCommisionAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public BBPSCommisionAdapter(Context context, List<BBPSCommisionModel> items, int animation_type) {
        this.items = items;
        ctx = context;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_bbpscommision, parent, false);
