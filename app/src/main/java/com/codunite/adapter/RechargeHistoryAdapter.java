...
public class RechargeHistoryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public class OriginalViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView txtOperator, txtMobile, txtType, memberDeatil, txtAfterBal, txtBeforeBal, operatorTransId;
        public CardView cardView;
        public View lyt_parent;
        public View layaccountno, laymobile, layOperatorTransId;
        ...
        public OriginalViewHolder(View v) {
            ...
            operatorTransId= (TextView) v.findViewById(R.id.operator_trans_id);

            cardView = (CardView) v.findViewById(R.id.cardview);
            lyt_parent = (View) v.findViewById(R.id.lyt_parent);
            layOperatorTransId = (View) v.findViewById(R.id.lay_operator_trans_id);
        }
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof OriginalViewHolder) {
            ...
            if (items.get(position).getOperatorTranId().equalsIgnoreCase("")){
                view.layOperatorTransId.setVisibility(View.GONE);
            }else {
                view.layOperatorTransId.setVisibility(View.VISIBLE);
                view.operatorTransId.setText(items.get(position).getOperatorTranId());
            }
