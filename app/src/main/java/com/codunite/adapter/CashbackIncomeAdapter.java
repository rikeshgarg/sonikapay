...
public class CashbackIncomeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CashbackIncomeAdapter(Context context, List<LevelIncomeModel> items, int animation_type) {
        this.items = items;
        ctx = context;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_cashbaclincome, parent, false);
        ...
        if (holder instanceof OriginalViewHolder) {
            ...
            view.lyt_parent.setOnClickListener(view1 -> {
                if (mOnItemClickListener != null) {
                    mOnItemClickListener.onItemClick(view1, items.get(position).getStr_date(), position);
                }
            });
