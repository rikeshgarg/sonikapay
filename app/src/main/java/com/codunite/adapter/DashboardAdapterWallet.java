...
public class DashboardAdapterWallet extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public DashboardAdapterWallet(Context context, List<DashboardModel> items, int animation_type) {
        this.items = items;
        ctx = context;
